    ...
    <div class="col-lg-pull-12" style="margin-top:10px">        
        <div class="col-md-6 col-xs-12">
            <span style="font-family:Calibri; font-weight:bold; text-transform:uppercase; color:#337AB7; margin-left:15px; padding:0; font-size:18px;">
                <i class="fa fa-book fa-fw"></i> Crear nuevo tipo de caso
            </span>
        </div>

        <div class="col-md-6 col-xs-12">
            <a href="<?php echo site_url('tipo_incidentes/index')?>" class="btn btn-default pull-right" style="margin-right: 5px"><i class="fa fa-arrow-circle-left"></i> Regresar</a>
...
<script type="text/javascript">
    function guardar()
    {
        ...
        {
            $.ajax({
                url: '<?php echo site_url('tipo_incidentes/create_action'); ?>',
                type: 'POST',
                data: {
                    nombre: nombre
                },
