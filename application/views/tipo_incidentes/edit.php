...
<?php
    $txtTipoIncidente = array(
        'id'                => 'txttipoincidente',
        'name'              => 'txttipoincidente',
        'class'             => 'form-control',
        'placeholder'       => 'Tipo de incidente',
        'style'             => 'width: 80%',
        'value'             => set_value('txttipoincidente', $tipo_incidente[0]->descripcion)
    );    
?>
    ...
    <div class="col-lg-pull-12" style="margin-top:10px">        
        <div class="col-md-6 col-xs-12">
            <span style="font-family:Calibri; font-weight:bold; text-transform:uppercase; color:#337AB7; margin-left:15px; padding:0; font-size:18px;">
                Modificar tipo de caso
            </span>
        </div>

        <div class="col-md-6 col-xs-12">
            <a href="<?php echo site_url('tipo_incidentes/detail/'). $tipo_incidente[0]->id; ?>" class="btn btn-default pull-right" style="margin-right: 5px"><i class="fa fa-arrow-circle-left"></i> Regresar</a>
            ...
            <div style="margin:0; padding:0;">
                <table class="register-table" style="margin-left:0; border-collapse:collapse">
                    <tr>
                        ...
                        <td class="campo">
                            <?php echo form_input($txtTipoIncidente); ?>
                        </td>
                    </tr>
                </table>
            </div>
...
<script type="text/javascript">
    function guardar()
    {
        var id = '<?php echo $tipo_incidente[0]->id; ?>';
        var nombre = $("#txttipoincidente").val();

        if (nombre != "") 
        {
            $.ajax({
                url: '<?php echo site_url('tipo_incidentes/edit_action'); ?>',
                type: 'POST',
                data: {
                    id: id,
                    nombre: nombre
                ...
                success: function(data) {
                    var url = '<?php echo site_url('tipo_incidentes/detail'); ?>'+'/'+ id;
