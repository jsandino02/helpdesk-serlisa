...
<div class="row">
    <div class="col-lg-pull-12" style="margin-top:10px">        
        ...
        <div class="col-md-6 col-xs-12">
            ...
            <a href="<?php echo site_url('subcategorias/edit/').$subcategoria->id; ?>" class="btn btn-primary pull-right" style="margin-right: 5px"><i class="fa fa-edit"></i> Modificar</a>
        </div>
    </div>
</div>
...
<div class="col-lg-8">
    <div class="panel panel-primary">
        <div class="panel-heading">
            Datos de la subcategor&iacute;a
        </div>
