...
<div class="col-lg-12" style="padding-left:0">
    <div class="row">
        <table id="tblIncidentes" class="display responsive nowrap table-hover table table-striped table-bordered" style="font-family:Calibri; font-size: 15px; width: 100%" cellspacing="1">
            <thead>
                <tr>
                    <th>TICKET</th>
                	<th>CREADO</th>
