    ...
    <div class="col-lg-pull-12" style="margin-top:10px">
        <div class="col-md-6 col-xs-12">
            <span style="font-family:Calibri; font-weight:bold; text-transform:uppercase; color:#337AB7; padding:0; font-size:20px;">
                <i class="fa fa-flag fa-fw"></i>&nbsp;<?php echo $title; ?>
            </span>
        </div>
...
<div class="row">
    <div class="col-md-8">
        <table width="100%" id="tblPerfiles" class="table-hover table table-striped" style="font-family:Calibri; font-size: 16px;" cellspacing="0">
            <thead>
                <tr>
            ...
            <tbody>
                <?php foreach ($perfiles as $perfil) { ?>
                    <tr>
                        <td>
                            <a href="<?php echo site_url('profiles/detail/').$perfil->id; ?>"><?php echo $perfil->descripcion; ?></a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>            
...
function nuevo()
{
	var url = '<?php echo site_url('profiles/create'); ?>';
